...
public:
	...
	static QVector2D detectOneRadialInScaled(RoadGraph& roads, AbstractArea& area, float scale);
	static QVector2D detectOneRadialInScaled(RoadGraph& roads, AbstractArea& area, float scale, QVector2D& centerApprox, float distanceThreshold, float angleThreshold);
